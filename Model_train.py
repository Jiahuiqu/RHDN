...
data_path = os.getcwd() + '/data/pavia'  # data load path
weights_path = os.getcwd() + '/weights/pavia'  # Weights saving path
fusion_path = os.getcwd() + '/fusion/pavia'  # Fusion result save path
